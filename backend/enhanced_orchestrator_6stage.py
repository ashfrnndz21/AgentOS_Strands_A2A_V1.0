                ...
                if matching_agent:
                    agent_evaluations.append({
                        ...
                        "capabilities_assessment": {
                            "what_this_agent_can_do": matching_agent.get('capabilities', []),
                            "tools_and_how_they_help": llm_eval.get('capability_analysis', f"Can help with {stage_1.get('domain', 'general')} tasks")
                        },
                        "tools_analysis": {
                            "available_tools": matching_agent.get('tools', []),
                            "how_they_help": llm_eval.get('tools_analysis', f"Tools enable {stage_1.get('domain', 'general')} assistance")
                        },
                        "system_prompt_analysis": {
                            "defines_their_role": llm_eval.get('role_analysis', f"Agent specializes in {matching_agent.get('description', 'general assistance')}")
                        },
        ...
        return {
            ...
            'stage_4_agent_analysis': {
                'agent_evaluations': [{
                    ...
                    'capabilities_assessment': {'what_this_agent_can_do': best_agent.get('capabilities', []), 'tools_and_how_they_help': ['General assistance']},
                    'tools_analysis': {'available_tools': best_agent.get('tools', []), 'how_they_help': 'Standard tools'},
                    'system_prompt_analysis': {'defines_their_role': f"Agent specializes in {best_agent.get('description', 'general assistance')}"},
