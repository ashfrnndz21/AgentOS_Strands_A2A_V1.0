...
print("\n🎯 CREATING MISSING ARCHITECTURE DESIGN COMPONENTS:")

# Create TechnicalBuildingBlocks component
technical_building_blocks = '''import React from 'react';
...
with open("src/components/ArchitectureDesign/TechnicalBuildingBlocks.tsx", 'w') as f:
    f.write(technical_building_blocks)

print("   ✅ Created TechnicalBuildingBlocks.tsx")

# Create ComponentLibrary component
component_library = '''import React from 'react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../ui/card';
import { Button } from '../ui/button';
import { Badge } from '../ui/badge';
...
with open("src/components/ArchitectureDesign/ComponentLibrary.tsx", 'w') as f:
    f.write(component_library)

print("   ✅ Created ComponentLibrary.tsx")

# Check if Input component exists, if not create it
if not os.path.exists("src/components/ui/input.tsx"):
...
export { Input }'''
    ...
    print("   ✅ Created Input component")

print("\n✅ ALL MISSING COMPONENTS CREATED!")
print("=" * 50)

print("\n🎯 COMPONENTS FIXED:")
print("   ✅ TechnicalBuildingBlocks.tsx")
print("   ✅ ComponentLibrary.tsx") 
print("   ✅ Input.tsx (if missing)")

print("\n🚀 NEXT STEPS:")
print("   1. The import errors should now be resolved")
print("   2. Restart your frontend server")
print("   3. All routes should now be accessible")
...
print("\n💡 ALL FUNCTIONALITY RESTORED WITH ERROR HANDLING!")