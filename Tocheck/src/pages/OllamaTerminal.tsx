...
import { SimpleOllamaTerminal } from '@/components/SimpleOllamaTerminal';
import { BackendControl } from '@/components/BackendControl';

export const OllamaTerminalPage: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
          ...
          <p className="text-white">
            Terminal connects to backend on <span className="font-mono bg-gray-800 px-2 py-1 rounded">localhost:5001</span>
          </p>
