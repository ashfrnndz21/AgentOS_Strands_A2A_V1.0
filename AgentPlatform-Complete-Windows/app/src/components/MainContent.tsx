...
import { Bot, Command, Workflow, ShoppingBag, TrendingUp, Users, CreditCard, PiggyBank } from "lucide-react";

export const MainContent = () => {
  return (
    <div className="flex-1 p-6 md:p-10 space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-white">Intelligent Agent OS</h1>
        <p className="text-gray-400 mt-2">AI-powered solutions for modern operations</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="bg-beam-dark-accent border-gray-700 p-6 hover:border-beam-blue/50 transition-colors">
          ...
          <p className="text-gray-400 mb-4">Centrally manage all banking AI operations</p>
        ...
        <Card className="bg-beam-dark-accent border-gray-700 p-6 hover:border-beam-blue/50 transition-colors">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">AI Agents</h2>
          <p className="text-gray-400 mb-4">Manage intelligent banking assistants</p>
          <Button asChild variant="default" className="w-full bg-beam-blue hover:bg-beam-blue/90">
        ...
        <Card className="bg-beam-dark-accent border-gray-700 p-6 hover:border-beam-blue/50 transition-colors">
          ...
          <p className="text-gray-400 mb-4">Interactive environment for banking AI deployment</p>
          <Button asChild variant="default" className="w-full bg-beam-blue hover:bg-beam-blue/90">
        ...
        <Card className="bg-beam-dark-accent border-gray-700 p-6 hover:border-beam-blue/50 transition-colors">
          ...
          <p className="text-gray-400 mb-4">Discover banking-specific AI solutions</p>
          <Button asChild variant="default" className="w-full bg-beam-blue hover:bg-beam-blue/90">
        ...
        <Card className="bg-beam-dark-accent border-gray-700 p-6 hover:border-beam-blue/50 transition-colors">
          <div className="h-12 w-12 rounded-lg bg-beam-dark flex items-center justify-center mb-4">
            <TrendingUp className="h-6 w-6 text-beam-blue" />
          </div>
          <h2 className="text-xl font-semibold text-white mb-2">Risk Analytics</h2>
          <p className="text-gray-400 mb-4">Advanced risk modeling and fraud detection</p>
          <Button asChild variant="default" className="w-full bg-beam-blue hover:bg-beam-blue/90">
        ...
        <Card className="bg-beam-dark-accent border-gray-700 p-6 hover:border-beam-blue/50 transition-colors">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Customer Insights</h2>
          <p className="text-gray-400 mb-4">Deep customer analytics and personalization</p>
          <Button asChild variant="default" className="w-full bg-beam-blue hover:bg-beam-blue/90">
