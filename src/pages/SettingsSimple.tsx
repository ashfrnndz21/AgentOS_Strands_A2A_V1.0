...
import { Settings as SettingsIcon, Moon, Sun, Upload, RotateCcw, Eye, Check, X, Image } from 'lucide-react';
    ...
    <div className="container mx-auto py-6 max-w-4xl">
      ...
      <div className="mb-4 p-3 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
        <p className="text-yellow-300 text-sm">
          <strong>Debug:</strong> Current tab is "{activeTab}" | Settings page is working!
        </p>
      </div>
